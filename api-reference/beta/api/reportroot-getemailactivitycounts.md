...
```
[!include[Example Code]( ../includes/reportroot_getemailactivitycounts_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getemailactivitycounts_json-snippets.md)]
<!--
{
