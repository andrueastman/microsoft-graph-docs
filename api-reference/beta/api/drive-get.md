...
```
[!include[Example Code]( ../includes/get-drive-default-snippets.md)]
...
```
[!include[Example Code]( ../includes/get-drive-by-user-snippets.md)]
...
```
[!include[Example Code]( ../includes/get-drive-by-group-snippets.md)]
...
```
[!include[Example Code]( ../includes/get-drive-by-id-snippets.md)]
