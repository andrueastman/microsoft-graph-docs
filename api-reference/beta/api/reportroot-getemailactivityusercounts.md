...
```
[!include[Example Code]( ../includes/reportroot_getemailactivityusercounts_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getemailactivityusercounts_json-snippets.md)]
<!--
{
