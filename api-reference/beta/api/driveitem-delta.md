...
```
[!include[Example Code]( ../includes/get_item_delta_first-snippets.md)]
...
```
[!include[Example Code]( ../includes/get_item_delta_last-snippets.md)]
...
```
[!include[Example Code]( ../includes/get-delta-latest-snippets.md)]
