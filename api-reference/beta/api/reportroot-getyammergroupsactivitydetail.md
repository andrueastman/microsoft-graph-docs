...
```
[!include[Example Code]( ../includes/reportroot_getyammergroupsactivitydetail_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getyammergroupsactivitydetail_json-snippets.md)]
<!--
{
