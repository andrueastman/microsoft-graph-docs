...
```
[!include[Example Code]( ../includes/reportroot_getemailactivityuserdetail_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getemailactivityuserdetail_json-snippets.md)]
<!--
{
