...
```
[!include[Example Code]( ../includes/reportroot_getyammergroupsactivitygroupcounts_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getyammergroupsactivitygroupcounts_json-snippets.md)]
<!--
{
