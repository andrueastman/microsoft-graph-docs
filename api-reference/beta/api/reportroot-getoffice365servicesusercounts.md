...
```
[!include[Example Code]( ../includes/reportroot_getoffice365servicesusercounts_csv-snippets.md)]
...
```
[!include[Example Code]( ../includes/reportroot_getoffice365servicesusercounts_json-snippets.md)]
<!--
{
