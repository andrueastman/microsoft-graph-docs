...
```
[!include[Example Code]( ../includes/\api-reference\beta\api\privilegedoperationevent-list.md #0-snippets.md)]
...
```
[!include[Example Code]( ../includes/\api-reference\beta\api\privilegedoperationevent-list.md #1-snippets.md)]
...
```
[!include[Example Code]( ../includes/\api-reference\beta\api\privilegedoperationevent-list.md #2-snippets.md)]
...
```
[!include[Example Code]( ../includes/\api-reference\beta\api\privilegedoperationevent-list.md #3-snippets.md)]
